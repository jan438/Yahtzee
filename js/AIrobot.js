...
YAHTZEE.scoreResults = function() {
	...
	var AIcount = 0;
	if ($('#chkAIone').parent().parent().hasClass('highlight')) AIcount++;
	if ($('#chkAItwo').parent().parent().hasClass('highlight')) AIcount++;
	if ($('#chkAIthree').parent().parent().hasClass('highlight')) AIcount++;
	if ($('#chkAIfour').parent().parent().hasClass('highlight')) AIcount++;
	if ($('#chkAIfive').parent().parent().hasClass('highlight')) AIcount++;
	if ($('#chkAIsix').parent().parent().hasClass('highlight')) AIcount++;
	if ($('#chkAIthreeofakind').parent().parent().hasClass('highlight')) AIcount++;
	if ($('#chkAIcarre').parent().parent().hasClass('highlight')) AIcount++;
	if ($('#chkAIfull').parent().parent().hasClass('highlight')) AIcount++;
	if ($('#chkAIsmallstr').parent().parent().hasClass('highlight')) AIcount++;
	if ($('#chkAIlargestr').parent().parent().hasClass('highlight')) AIcount++;
	if ($('#chkAIyahtzee').parent().parent().hasClass('highlight')) AIcount++;
	if ($('#chkAIchance').parent().parent().hasClass('highlight')) AIcount++;
